...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Gestion des Services inclus</h1>
    </div>
    ...
    <div class="row">
        <div class="lg-12">
            ...
            <!--<a href=<?= $this->Url->build(['controller' => 'Serviceinclus', 'action' => 'index']) ?> class="btn btn-success btn-icon-split">
    ...
    <div class="card shadow mb-6">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ajouter un service inclus</h6>
        </div>
        <div class="card-body">
            <?= $this->Form->create($serviceinclus) ?>
            ...
            <div class="form-group">
                <?= $this->Form->control('name', ['type' => 'text', 'class' => 'form-control', 'label' => 'Nom du service:']); ?>
            </div>

...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="lg-12">
            ...
            <?= $this->Html->link(__('Ajouter un matériel inclus'), ['controller' => 'Materielinclus', 'action' => 'add', $offre->id], ['class' => 'btn btn-warning']) ?>
                        ...
                        <table>
                            ...
                            <?php foreach ($offre->materielinclus as $materielinclus) : ?>
                                <tr>
                                    ...
                                    <td><?= h($materielinclus->modified) ?></td>
                                    <td class="actions">
                                        <?= $this->Html->link(__('Détails'), ['controller' => 'Materielinclus', 'action' => 'view', $materielinclus->id]) ?>
                        ...
                        <table>
                            ...
                            <?php foreach ($offre->serviceinclus as $serviceinclus) : ?>
                                <tr>
                                    ...
                                    <td><?= h($serviceinclus->modified) ?></td>
                                    <td class="actions">
                                        <?= $this->Html->link(__('Détails'), ['controller' => 'Serviceinclus', 'action' => 'view', $serviceinclus->is]) ?>

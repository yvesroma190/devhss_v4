...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="lg-12">
            <?= $this->Html->link(__('Liste des états de paiement'), ['action' => 'index'], ['class' => 'btn btn-info']) ?>
            <?= $this->Html->link(__('Créer un état'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
            <?= $this->Html->link(__('Modifer'), ['action' => 'edit', $etatpaiement->id], ['class' => 'btn btn-success']) ?>
            <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $etatpaiement->id], ['confirm' => __('Voulez-vous supprimer l\'état? # {0}?', $etatpaiement->id), 'class' => 'btn btn-danger']) ?>
        </div>
    </div>
    <hr class="sidebar-divider d-none d-md-block">
                        ...
                        <table>
                            ...
                            <?php foreach ($etatpaiement->paiements as $paiements) : ?>
                                <tr>
                                    ...
                                    <td><?= h($paiements->modified) ?></td>
                                    <td class="actions">
                                        <?= $this->Html->link(__('Détails'), ['controller' => 'Paiements', 'action' => 'view', $paiements->id]) ?>
